...
#### 2025/04 - 現在： 経済情報プラットフォームの開発

役割：バックエンド、フロントエンド（メンバー）

チーム：2人

#### 2025/01 - 2025/03 現在： 経済情報プラットフォームの開発

主に技術者向けに特許や論文情報を提供する機能の開発

役割：バックエンド、フロントエンド（メンバー）

チーム：5人

- 使用技術：Angular Dart、Rust（Actix）、Kotlin（Spring Boot）、Python、Kubernetes


#### 2024/07 - 2024/12： 経済情報プラットフォームの開発
役割：バックエンド、フロントエンド（メンバー）
...
- 2024/01からのチーム体制に、入れ替わり1名、追加2名の計7名による、新規機能の開発と小規模改善
- 使用技術：Kotlin(Spring Boot)、Rust(Actix)、TypeScript(Lit)、Kubernetes


#### 2024/01 - 2024/03： 経済情報プラットフォームの開発
役割：バックエンド、フロントエンド（メンバー）

チーム：5人

- 2023/10からのチーム体制（と1名入れ替わり）で、新規機能の開発
- 使用技術：Kotlin(http4k, Spring Boot)、Rust(Actix)、TypeScript(Lit)、Kubernetes

#### 2023/10 - 2023/12： 経済情報プラットフォームの開発
役割：バックエンド、フロントエンド（メンバー）

チーム：5人

- 4月からのチームに2名のメンバーを面談で採用し、5名のアジャイルなチームづくりへの挑戦
- プロダクトの1機能の小規模改善を対応
- 使用技術：Kotlin(Spring Boot)、Angular Dart、Python、Rust、Next.js、TypeScript、Kubernetes

#### 2023/04 - 2023/09： 経済情報プラットフォームの開発
役割：バックエンド、フロントエンド（メンバー）
...
- 新しいメンバーにペアプロを教える過程で学んだことをXP祭りにて登壇
  - [より協力的なペアプロを促すには どうするかを考える](https://speakerdeck.com/jnuank/yorixie-li-de-napeapurowocu-suniha-dousurukawokao-eru-81592987-dff1-44f1-9ae3-630f0d9d33e3)
...
#### 2022/03 - 2022/12 ：新規プロジェクト立ち上げ
役割：バックエンド、フロントエンド（メンバー）

チーム：5人

- 使用技術：Rust Axum、TypeScript lit、Go、Kubernetes
- ペアプロに関する記事をポスト
  - [ペアプロは秒のフィードバックを回し続ける](https://tech.uzabase.com/entry/2022/03/02/110132)

#### 2022/02 - 2022/03： 経済情報プラットフォームの開発
役割：バックエンド、フロントエンド（メンバー）

チーム：7人

- 使用技術：Kotlin、Angular Dart、Kubernetes
...
- XPベースのアジャイル開発で、フルタイムでのペアプロ・TDDの実践をしています。
- バックエンド、BFF、フロントエンドの開発全般に携わっています。
- 使用技術：Kotlin、Clojure、Angular Dart、Kubernetes
...
#### 2023/07 - 現在： 開発組織の原則明文化（兼任）

チーム：4人

- 開発組織内で大事にしていることを原則という形で言語化することを行っています
...
- 面接のスキルを一定向上するための施策を行っています

#### 2022/07 - 2022/12：オンボーディング施策（兼任）

チーム：4人

- 社内のオンボーディングプロセスについて疑問があったため、プロセスを策定と実施をしているチームに入りました


#### 2021/07 - 2023/06： エンジニア採用（兼任）

チーム：4人

- エンジニア採用のロールに興味があり、採用の施策を行うチームも兼任しました
- 主にやったこと
  - 採用の選考フローの見直し
  - 業務委託のエージェントとのやり取り、候補者との面談
  - 採用パイプラインの管理、ファネル分析
  - スカウト媒体の選定
  
開発から時間を割いて行なうため、緊急タスク以外はカンバンを用いて毎週プランニングを行い、無理ない範囲で施策を行なうようにしています。
...
- このときのプロジェクトは試行錯誤の連続であった為、イテレーションを1週間→1日にして細かく対応を変更ができるように行った
  - [1週間ですら見積もれなかったからイテレーションを1日にしてみた](https://speakerdeck.com/jnuank/1zhou-jian-desurajian-ji-morenakatutakaraiteresiyonwo1ri-nisitemita)
